...
figma.ui.onmessage = msg => {
  // Log every message received from the UI
  ...
  if (msg.type === 'import-tokens') {
    ...
    try {
      ...
      if (data.color && typeof data.color === 'object') {
        tokensImported = true;
        let colorCollection = getOrCreateCollection('Design Tokens/Colors');
      ...
      if (data.layout?.spacing && typeof data.layout.spacing === 'object') {
        tokensImported = true;
        let spacingCollection = getOrCreateCollection('Design Tokens/Spacing');
      ...
      if (data.layout?.borderRadius && typeof data.layout.borderRadius === 'object') {
        tokensImported = true;
        let radiusCollection = getOrCreateCollection('Design Tokens/BorderRadius');
      ...
      if (data.layout?.screens && typeof data.layout.screens === 'object') {
        tokensImported = true;
        let screensCollection = getOrCreateCollection('Design Tokens/Screens');
      ...
      if (data.effects?.boxShadow && typeof data.effects.boxShadow === 'object') {
        tokensImported = true;
        let effectsCollection = getOrCreateCollection('Design Tokens/Effects');
      ...
      if (data.typography && typeof data.typography === 'object') {
        ...
        if (data.typography.lineHeight && typeof data.typography.lineHeight === 'object') {
          let lineHeightCollection = getOrCreateCollection('Design Tokens/LineHeight');
      ...
      // Log if a message with an unknown type is received
